...
<form name="cus_loginform" id="cus_loginform" action="<?php echo get_ssl_normal_url(home_url().'/index.php?ptype=login'); ?>" method="post" >
...
<form name="lostpasswordform" id="lostpasswordform" action="<?php echo get_ssl_normal_url(home_url().'/?ptype=login&action=lostpassword'); ?>" method="post">
