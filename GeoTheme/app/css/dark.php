...
div.content ul li a.clicked {
	color: white;
	background: -webkit-gradient(linear, 0% 0%, 0% 100%, from(#7AD62B), to(#56961E));
}
...
div.content div.label {
	float: left;
	width: 70px;
	background: -webkit-gradient(linear, 0% 0%, 0% 100%, from(#323437), to(#3C3E40));
...
color: #fff;border-radius: 5px;border: 1px solid #6d6d6d;font-size: 12px;left: 310px;position: fixed;top: 9px;padding: 5px 8px;text-decoration:none;}
		...
		#main .content {margin-top:20px;}
			...
			/* Box white */
			#main .content .box-white {background:#fff;border:1px solid #B4B7BB;border-radius:10px;margin: 0 10px;background: -webkit-gradient(linear, 0% 0%, 0% 100%, from(#575859), to(#424344));
}
				#main .content .box-white p:first-child {color: #cecece;text-shadow: #222222 1px 1px 1px;border-bottom:1px solid #333;font-weight:bold;margin:0;padding:10px;}
				#main .content .box-white p {color: #cecece;text-shadow: #222222 1px 1px 1px;font-weight:bold;margin:0;padding:10px;}
					#main .content .box-white p:last-child {border-bottom:none;}
				#main .content .box-white p span {color: #cecece;text-shadow: #222222 1px 1px 1px;float:right;font-weight:normal;}
...
.ddown {background:#000;display:none;}
